        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2">
              <CurrencyDollarIcon className="h-[18px] w-[18px] text-gray-500" />
            </div>
            <input
              id="amount"
              name="amount"
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3" aria-describedby="status-error">
            <div className="flex gap-4">
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="paid"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-green-100 px-3 py-1.5 text-sm font-medium text-green-600"
                >
